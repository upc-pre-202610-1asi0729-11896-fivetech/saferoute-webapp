...
const tripList         = () => import('./trip-list/trip-list').then(m => m.TripList);
const tripForm         = () => import('./trip-form/trip-form').then(m => m.TripForm);
const liveMonitor      = () => import('./live-monitor/live-monitor').then(m => m.LiveMonitor);
const parentTracking   = () => import('./parent-tracking/parent-tracking').then(m => m.ParentTracking);
const activeTrip       = () => import('./active-trip/active-trip').then(m => m.ActiveTrip);
const attendanceHistory = () => import('./attendance-history/attendance-history').then(m => m.AttendanceHistory);
